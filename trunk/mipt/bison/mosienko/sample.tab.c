...
/* Line 1806 of yacc.c  */
#line 33 "sample.y"
    { sym[(yyvsp[(1) - (3)].var_node)->Name - 'a'] = (yyvsp[(3) - (3)].node); }
    break;
...
/* Line 1806 of yacc.c  */
#line 38 "sample.y"
    { (yyval.node) = sym[(yyvsp[(1) - (1)].var_node)->Name - 'a']; }
    break;
...
#line 39 "sample.y"
    {
        ...
        res->Left = (yyvsp[(1) - (3)].node);
        res->Right = (yyvsp[(3) - (3)].node);
        (yyval.node) = res; }
    break;
